...
out="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/DPR_training_checkpoint/mlm+cl+mask_1228"

python train_dense_encoder.py \
train_datasets="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/biencoder-webquestions-traintest.json" \
dev_datasets="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/biencoder-webquestions-dev.json" \
train=biencoder_local \
checkpoint_file_name="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/DPR_training_checkpoint/mlm+cl+mask_1231/hf_bert_base.cp" \
output_dir=${out} \

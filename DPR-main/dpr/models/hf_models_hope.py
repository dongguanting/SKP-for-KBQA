...
class HFBertEncoder(BertModel):
    ...
    def init_encoder(
        ...
        if pretrained:
            ...
            return cls.from_pretrained("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/bert-base-uncased", config=cfg, project_dim=projection_dim, **kwargs)
        else:

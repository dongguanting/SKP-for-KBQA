...
def get_bert_tokenizer(pretrained_cfg_name: str, do_lower_case: bool = True):
    return BertTokenizer.from_pretrained("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/bert-base-uncased", do_lower_case=do_lower_case)
...
class HFBertEncoder(BertModel):
    ...
    def init_encoder(
        ...
        # cfg = BertConfig.from_pretrained("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/bert-base-uncased")
        # import pdb
        # pdb.set_trace()
        if dropout != 0:
        ...
        if pretrained:
            ...
            return cls.from_pretrained("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/bert_pretraining_checkpoints/random_100w_epoch10_ml+cl_training_mask", config=cfg, project_dim=projection_dim, **kwargs)
        else:

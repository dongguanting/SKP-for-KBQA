...
nlp = spacy.load("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/dongguanting/DPR-main/en_core_web_sm-3.0.0/en_core_web_sm/en_core_web_sm-3.0.0", disable=["parser", "tagger", "ner", "entity_ruler"])
